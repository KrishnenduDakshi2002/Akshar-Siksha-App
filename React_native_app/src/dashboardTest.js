      ...
      >
        ...
        <View style={{display: 'flex', flexDirection: 'row', justifyContent:'space-between', alignItems: 'center'}}>
          <Pressable onPress={() => {
            ...
            <Text style={{textAlign: 'center', fontSize: 15, color:'white'}}>Find/donate supplies</Text>
          </Pressable>

          <Pressable onPress={() => {
            navigation.navigate('Event');
          }} style={{ height: 70, backgroundColor: '#28800b', borderRadius: 4, padding: 8, margin: 8, flex: 1,justifyContent:"center"}}>
            <Text style={{textAlign: 'center', fontSize: 15, color: 'white'}}>Locate Events</Text>
          </Pressable>
        </View>
